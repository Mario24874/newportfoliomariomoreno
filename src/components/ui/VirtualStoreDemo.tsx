...
const VirtualStoreDemo: React.FC<VirtualStoreDemoProps> = ({ onPriceUpdate }) => {
  ...
  const products: Product[] = [
    {
      id: 1,
      name: 'IMPERIAL ARMY´S TIE FIGHTER',
      nameEs: 'CAZA TIE DEL EJÉRCITO IMPERIAL',
      price: 2999,
      originalPrice: 2999,
      ...
      specs: ['ENGENIE UNIT', 'P-S4 TWIN / P-W401'],
      specsEs: ['UNIDAD DE INGENIERIA', 'P-S4 TWIN  P-W401'],
      durability: 95
    },
    {
      id: 2,
      name: 'KYLO REN´S LIGHTSABER',
      nameEs: 'SABLE LÁSER DE KYLO REN',
      price: 4599,
      originalPrice: 4599,
      ...
      specs: ['VOLTAGE RANGE: 2000 WATT / 2800 WATT', 'LASER SIZE: S / M / L / XL'],
      specsEs: ['RANGO DE VOLTAJE: 2000 WATT / 2800 WATT', 'TAMAÑO DEL LÁSER: S / M / L / XL'],
      durability: 88
    },
    {
      id: 3,
      name: 'IMPERIAL ARMY DEATH STAR',
      nameEs: 'ESTRELLA DE LA MUERTE DEL EJÉRCITO IMPERIAL',
      price: 1899,
      originalPrice: 1899,
      ...
      specs: ['HYPERDRIVE CLASSIFICATION: CLASS 4 / CLASS 20', 'WEAPON: SUPERLASER / TURBOLASER'],
      specsEs: ['CLASIFICACIÓN DE HIPERPROPULSIÓN: CLASE 4 / CLASE 20', 'ARMAMENTO: SUPERLASER / TURBOLASER'],
      durability: 92
    },
    {
      id: 4,
      name: 'STORMTROOPER HELMET',
      nameEs: 'CASCO DE STORMTROOPER',
      price: 1299,
      originalPrice: 1299,
      ...
      specs: ['HELMET SIZE', 'S/ M / L / XL'],
      specsEs: ['TALLA CASCO', 'S / M / L / XL'],
      durability: 85
    }
  ];
